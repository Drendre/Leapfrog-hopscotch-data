%% Function File: Algorithm_1_v1_FullCNe.m 


	function Algorithm_1_v1_FullCNe( Label, Path_To_Result_Folder, Theta_0, Theta_1, Theta_2, Theta_3, Theta_4 )
					...
					for iRun=1:1:NRun 
						...
						for i=1:1:N 
							...
							if( cellParity(i)<0 ) % ODD cells			
								...
								uNum(i) =  uNum(i)*e1half(i)+a/b(i)*(1-e1half(i)); 									
						...
						for t = 1:2:(T-2)		
							...
							for i = 1:1:N
								...
								if( cellParity(i)>0 ) % EVEN cells
									...
									uNum(i) =  uNum(i)*e1(i)+a/b(i)*(1-e1(i)); 													
